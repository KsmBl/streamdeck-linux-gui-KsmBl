...
* **Sample Icons**: An **Icons…** button offers ready-made button images: bundled sets (media, volume, brightness, web, system), your installed browsers' real icons (Firefox, Chrome, Chromium, Edge, Vivaldi, Brave), and — when Font Awesome is installed — a Font Awesome category. Browser and Font Awesome icons are rendered from fonts/themes already on your system.
