...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionThemeDefault = QAction(MainWindow)
        self.actionThemeDefault.setObjectName(u"actionThemeDefault")
        self.actionThemeDefault.setCheckable(True)
        self.actionThemeXP = QAction(MainWindow)
        self.actionThemeXP.setObjectName(u"actionThemeXP")
        self.actionThemeXP.setCheckable(True)
        self.actionThemeModern = QAction(MainWindow)
        self.actionThemeModern.setObjectName(u"actionThemeModern")
        self.actionThemeModern.setCheckable(True)
        self.actionModernAccent = QAction(MainWindow)
        self.actionModernAccent.setObjectName(u"actionModernAccent")
        ...
        icon_gear = QIcon()
        icon_gear.addFile(u":/icons/icons/gear.png", QSize(), QIcon.Normal, QIcon.Off)
        self.page_settings.setIcon(icon_gear)

        self.pageActions.addWidget(self.page_settings)
        ...
        self.menuView.addAction(self.actionThemeDefault)
        self.menuView.addAction(self.actionThemeXP)
        self.menuView.addAction(self.actionThemeModern)
        self.menuView.addSeparator()
        self.menuView.addAction(self.actionDarkMode)
        self.menuView.addAction(self.actionModernAccent)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionThemeDefault.setText(QCoreApplication.translate("MainWindow", u"Default Theme", None))
        self.actionThemeXP.setText(QCoreApplication.translate("MainWindow", u"Windows XP Theme", None))
        self.actionThemeModern.setText(QCoreApplication.translate("MainWindow", u"Modern Theme", None))
        self.actionModernAccent.setText(QCoreApplication.translate("MainWindow", u"Modern Accent Colour…", None))
