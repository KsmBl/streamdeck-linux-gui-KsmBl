...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionXPTheme = QAction(MainWindow)
        self.actionXPTheme.setObjectName(u"actionXPTheme")
        self.actionXPTheme.setCheckable(True)
        self.actionModernTheme = QAction(MainWindow)
        self.actionModernTheme.setObjectName(u"actionModernTheme")
        self.actionModernTheme.setCheckable(True)
        ...
        self.menuView.addAction(self.actionXPTheme)
        self.menuView.addAction(self.actionModernTheme)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionXPTheme.setText(QCoreApplication.translate("MainWindow", u"Windows XP Theme", None))
        self.actionModernTheme.setText(QCoreApplication.translate("MainWindow", u"Modern Theme", None))
