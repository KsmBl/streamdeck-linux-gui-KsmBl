...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionFollowFocus = QAction(MainWindow)
        self.actionFollowFocus.setObjectName(u"actionFollowFocus")
        self.actionFollowFocus.setCheckable(True)
        self.actionAssignFocusPage = QAction(MainWindow)
        self.actionAssignFocusPage.setObjectName(u"actionAssignFocusPage")
        self.actionClearFocusPage = QAction(MainWindow)
        self.actionClearFocusPage.setObjectName(u"actionClearFocusPage")
        ...
        self.menuView.addAction(self.actionFollowFocus)
        self.menuView.addAction(self.actionAssignFocusPage)
        self.menuView.addAction(self.actionClearFocusPage)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionFollowFocus.setText(QCoreApplication.translate("MainWindow", u"Follow Focused Application", None))
        self.actionAssignFocusPage.setText(QCoreApplication.translate("MainWindow", u"Assign Page to Focused App…", None))
        self.actionClearFocusPage.setText(QCoreApplication.translate("MainWindow", u"Clear Page's Focus App", None))
